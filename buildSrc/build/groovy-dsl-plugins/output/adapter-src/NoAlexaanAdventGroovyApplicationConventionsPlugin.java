...
/**
 * Precompiled no.alexaan.advent.groovy-application-conventions script plugin.
 **/
public class NoAlexaanAdventGroovyApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NoAlexaanAdventGroovyApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("no.alexaan.advent.groovy-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NoAlexaanAdventGroovyApplicationConventions").asSubclass(BasicScript.class);
