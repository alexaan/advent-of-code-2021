...
/**
 * Precompiled no.alexaan.advent.groovy-common-conventions script plugin.
 **/
public class NoAlexaanAdventGroovyCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NoAlexaanAdventGroovyCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NoAlexaanAdventGroovyCommonConventions").asSubclass(BasicScript.class);
